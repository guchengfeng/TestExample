...
@interface RootViewLayoutViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@interface RootViewLayoutViewController ()

@end

@implementation RootViewLayoutViewController
...
- (void)viewDidLoad {
    ...
    NSURL *plistFile = [[NSBundle mainBundle] URLForResource:plist_API_Masonry_Item withExtension:@"plist"];
