...
{
    if (SDK_VERSION >= 8.0) {
        _wkWebView.frame = CGRectMake(0, 100, self.bounds.size.width, self.bounds.size.height);
    } else {
        _webView.frame = CGRectMake(0, 100, self.bounds.size.width, self.bounds.size.height);
    }
    _exceptionView.frame = CGRectMake(0, 100, self.bounds.size.width, self.bounds.size.height);
}
